...
const CONTRACT_ON_CHAINS = {
    ...
    5: '0xCe7Fd3BcEffC3b647058d222472C7C7A52c99335',
...
const onSubmitContractRead = async (event) => {
    ...
    const GetGreeting = CONTRACT_ABI.find(i => i.name === 'mining_class');
...
const onSubmitContractWrite = async (event) => {
    ...
    // Setup Interface + Encode Function
    const SetGreeting = CONTRACT_ABI.find(i => i.name === 'mining_class');
